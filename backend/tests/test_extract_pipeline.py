...
try:
    import extract_pipeline  # noqa: E402
...
class ExtractPipelineTests(unittest.TestCase):
    ...
    def test_parser_valid_json_response(self):
        ...
        parsed, error = extract_pipeline.parse_llm_json_response(raw)
    ...
    def test_build_prompt_includes_feature_prompt_guidance(self):
        ...
        prompt = extract_pipeline.build_prompt("EF estimated at 50%.", features)
    ...
    def test_resume_skips_existing_output_ids(self):
        ...
        with patch("extract_pipeline.call_llamacpp_with_retries", return_value=success_payload):
            stats = extract_pipeline.run_extraction(args)
    ...
    def test_writes_one_row_per_input_including_errors(self):
        ...
        with patch("extract_pipeline.call_llamacpp_with_retries", side_effect=side_effects):
            stats = extract_pipeline.run_extraction(args)
