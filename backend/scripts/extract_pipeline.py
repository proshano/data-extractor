#!/usr/bin/env python3
"""
Standalone, resume-safe structured data extraction CLI.
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract structured features from free-text reports using local llama.cpp."
    )
...
def build_prompt(report_text: str, schema_features: Sequence[Dict[str, Any]]) -> str:
    ...
    return (
        "You are extracting structured findings from a single report.\n"
